...
FusionAuthClient.prototype = {
   ...
   *
   * @param {?UUIDString} accessControlListId (Optional) The Id for the ACL. If not provided a secure random UUID will be generated.
   ...
   * @param {Function} callBack The response handler call back. This function will be passed the ClientResponse object.
   */
  createACL: function(accessControlListId, request, callBack) {
      return this._start()
          .uri('/api/ip-acl')
   ...
   *
   * @param {UUIDString} ipAccessControlListId The Id of the ACL to delete.
   * @param {Function} callBack The response handler call back. This function will be passed the ClientResponse object.
   */
  deleteACL: function(ipAccessControlListId, callBack) {
      return this._start()
          .uri('/api/ip-acl')
   ...
   *
   * @param {UUIDString} formId The Id of the ACL.
   * @param {Function} callBack The response handler call back. This function will be passed the ClientResponse object.
   */
  retrieveACL: function(formId, callBack) {
      return this._start()
          .uri('/api/ip-acl')
          .urlSegment(formId)
          .get()
   ...
   * @param {Function} callBack The response handler call back. This function will be passed the ClientResponse object.
   */
  retrieveACLs: function(callBack) {
      return this._start()
          .uri('/api/ip-acl')
          .get()
          .go(callBack);
   ...
   * @param {Function} callBack The response handler call back. This function will be passed the ClientResponse object.
   */
  searchACLs: function(request, callBack) {
      return this._start()
   ...
   *
   * @param {UUIDString} accessControlListId The Id of the ACL to update.
   * @param {IPAccessControlListRequest} request The request that contains all of the new ACL information.
   * @param {Function} callBack The response handler call back. This function will be passed the ClientResponse object.
   */
  updateACL: function(accessControlListId, request, callBack) {
      return this._start()
          .uri('/api/ip-acl')
          .urlSegment(accessControlListId)
          .setJSONBody(request)
...
/**
 * @typedef {Object} CaptchaConfiguration
 * @extends Enableable
 *
 ...
 *
 * @property {Object<string, Object>} [data]
 * @property {IPAccessControlListMode} [defaultAction]
 * @property {Array<IPRange>} [exceptions]
 * @property {UUIDString} [id]
 * @property {number} [insertInstant]
 * @property {number} [lastUpdateInstant]
 * @property {string} [name]
 ...
 *
 * @property {Array<IPAccessControlList>} [acls]
 * @property {number} [total]
 */
 ...
 * @property {Object<string, Object>} [state]
 * @property {Array<AuthenticationThreats>} [threatsDetected]
 * @property {string} [token]
...
var RateLimitedRequestType = {
  ...
  ResendRegistrationVerification: "ResendRegistrationVerification",
 ...
 * @property {PasswordValidationRules} [passwordValidationRules]
 * @property {TenantRateLimitingConfiguration} [rateLimitingConfiguration]
 * @property {ObjectState} [state]
 * @property {UUIDString} [themeId]
 * @property {ThreatDetectionConfiguration} [threatDetectionConfiguration]
 ...
 * @author Daniel DeGroff
 *
 * @typedef {Object} TenantRateLimitingConfiguration
 *
 * @property {RateLimitedRequestConfiguration} [failedLogin]
 * @property {RateLimitedRequestConfiguration} [forgotPassword]
 * @property {RateLimitedRequestConfiguration} [resendEmailVerification]
 * @property {RateLimitedRequestConfiguration} [resendRegistrationVerification]
 * @property {RateLimitedRequestConfiguration} [sendPasswordlessEmail]
 * @property {RateLimitedRequestConfiguration} [sendTwoFactorEmail]
 * @property {RateLimitedRequestConfiguration} [sendTwoFactorSMS]
 */
 ...
 * @author Brett Pontarelli
 *
 * @typedef {Object} ThreatDetectionConfiguration
 *
 * @property {CaptchaConfiguration} [captcha]
 */
