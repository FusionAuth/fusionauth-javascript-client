...
FusionAuthClient.prototype = {
   ...
   * @param {Function} callBack The response handler call back. This function will be passed the ClientResponse object.
   */
  activateReactor: function(licenseId, request, callBack) {
      return this._start()
          .uri('/api/reactor')
 ...
 * @property {UnverifiedGatedOptions} [whenGated]
 */
 ...
 * @property {ApplicationUnverifiedConfiguration} [unverified]
 */
 ...
 *
 * @property {boolean} [requireAuthentication]
 * @property {TenantUnverifiedConfiguration} [unverified]
 */
 ...
 * @author Daniel DeGroff
 *
 * @typedef {Object} UnverifiedGatedOptions
 * @extends Enableable
 *
 * @property {boolean} [allowEmailChange]
